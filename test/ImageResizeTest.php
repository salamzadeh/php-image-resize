...
class ImageResizeTest extends TestCase
{
    ...
    public function testLoadGif()
    {
        ...
        $this->assertInstanceOf('\Salamzadeh\ImageResize', $resize);
    }
    ...
    public function testAddFilter()
    {
        ...
        $this->assertInstanceOf('\Salamzadeh\ImageResize', $resize->addFilter('imagefilter'));
    }
    ...
    public function testApplyFilter()
    {
        ...
        $this->assertInstanceOf('\Salamzadeh\ImageResize', $resize->save($filename));
    }
    ...
    /**
     * @expectedException \Salamzadeh\ImageResizeException
    ...
    public function testCropPosition()
    {
        ...
        $reflection_class = new ReflectionClass('\Salamzadeh\ImageResize');
