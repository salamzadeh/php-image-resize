...
[![Build Status](https://travis-ci.org/salamzadeh/php-image-resize.svg?branch=master)](https://travis-ci.org/salamzadeh/php-image-resize) [![Latest Stable Version](https://poser.pugx.org/salamzadeh/php-image-resize/v/stable)](https://packagist.org/packages/salamzadeh/php-image-resize) [![Monthly Downloads](https://poser.pugx.org/salamzadeh/php-image-resize/d/monthly)](https://packagist.org/packages/salamzadeh/php-image-resize)

Hosted Solution
---------------

If you don't want to crop, resize and store images on your server, <a href="https://www.salamzadeh.net" target="_blank">Salamzadeh.net</a> is a **free** service which can process images in real-time and serve worldwide through CDN.
...
This library is maintained by <a href="https://www.salamzadeh.net" target="_blank">Salamzadeh.net</a>
